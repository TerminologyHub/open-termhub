...
- `READ_ONLY`: When set to `true`, rejects HTTP APIs that add, alter, or remove content (403) and disables startup/cron syndication. Swagger/OpenAPI hides DELETE, PUT, PATCH, and POST operations. Default: false
