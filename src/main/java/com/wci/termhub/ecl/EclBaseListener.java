...
public class EclBaseListener implements EclListener {
	...
	/* see superclass */
	@Override
	public void enterConjunctionexpressionconstraint(final EclParser.ConjunctionexpressionconstraintContext ctx) { // n/a
	}

	/* see superclass */
	@Override
	public void exitConjunctionexpressionconstraint(final EclParser.ConjunctionexpressionconstraintContext ctx) { // n/a
	}

	/* see superclass */
	@Override
	public void enterDisjunctionexpressionconstraint(final EclParser.DisjunctionexpressionconstraintContext ctx) { // n/a
	}

	/* see superclass */
	@Override
	public void exitDisjunctionexpressionconstraint(final EclParser.DisjunctionexpressionconstraintContext ctx) { // n/a
	}

	/* see superclass */
	@Override
	public void enterExclusionexpressionconstraint(final EclParser.ExclusionexpressionconstraintContext ctx) { // n/a
	}

	/* see superclass */
	@Override
	public void exitExclusionexpressionconstraint(final EclParser.ExclusionexpressionconstraintContext ctx) { // n/a
	}
