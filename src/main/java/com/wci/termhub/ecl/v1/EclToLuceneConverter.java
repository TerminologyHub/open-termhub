...
public class EclToLuceneConverter {
   ...
   * component using the component's addExpressionConstraintListener method.
   * When the expressionConstraint event occurs, that object's appropriate
   * method is invoked.
   *
  ...
  protected static final class ExpressionConstraintListener extends EclBaseListener {
        ...
        if (constraintoperator == null) {
          ...
          if (constraintoperator.childof() != null) {
            ...
            if (!inAttribute) {
              ...
              luceneQuery
                  .append(InternalFunction.ATTRIBUTE_ANCESTOR_OR_SELF_OF + "(" + conceptId + ")");
            }
    ...
    public void enterEclattributename(final EclParser.EclattributenameContext cxt) {
      ...
      final EclParser.EclconceptreferenceContext conceptreference =
          cxt.subexpressionconstraint().eclfocusconcept().eclconceptreference();
    ...
    public void enterExpressioncomparisonoperator(
      final EclParser.ExpressioncomparisonoperatorContext cxt) {
    ...
    public void enterNumericcomparisonoperator(
      final EclParser.NumericcomparisonoperatorContext cxt) {
