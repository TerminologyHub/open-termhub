...
public class ECLParser extends Parser {
	...
	public static final int
		...
		RULE_eclfocusconcept = 9, RULE_dot = 10, RULE_memberof = 11, RULE_refsetfieldset = 12, 
		RULE_refsetfield = 13, RULE_refsetfieldname = 14, RULE_refsetfieldref = 15, 
		RULE_eclconceptreference = 16, RULE_eclconceptreferenceset = 17, RULE_conceptid = 18, 
		RULE_term = 19, RULE_wildcard = 20, RULE_constraintoperator = 21, RULE_descendantof = 22, 
		RULE_descendantorselfof = 23, RULE_childof = 24, RULE_childorselfof = 25, 
		RULE_ancestorof = 26, RULE_ancestororselfof = 27, RULE_parentof = 28, 
		RULE_parentorselfof = 29, RULE_conjunction = 30, RULE_disjunction = 31, 
		RULE_exclusion = 32, RULE_eclrefinement = 33, RULE_conjunctionrefinementset = 34, 
		...
		RULE_cardinality = 43, RULE_minvalue = 44, RULE_to = 45, RULE_maxvalue = 46, 
		RULE_many = 47, RULE_reverseflag = 48, RULE_eclattributename = 49, RULE_expressioncomparisonoperator = 50, 
		...
		RULE_language = 68, RULE_languagecode = 69, RULE_languagecodeset = 70, 
		RULE_typefilter = 71, RULE_typeidfilter = 72, RULE_typeid = 73, RULE_typetokenfilter = 74, 
		RULE_type = 75, RULE_typetoken = 76, RULE_typetokenset = 77, RULE_synonym = 78, 
		RULE_fullyspecifiedname = 79, RULE_definition = 80, RULE_dialectfilter = 81, 
		RULE_dialectidfilter = 82, RULE_dialectid = 83, RULE_dialectaliasfilter = 84, 
		RULE_dialect = 85, RULE_dialectalias = 86, RULE_dialectaliasset = 87, 
		RULE_dialectidset = 88, RULE_acceptabilityset = 89, RULE_acceptabilityconceptreferenceset = 90, 
		RULE_acceptabilitytokenset = 91, RULE_acceptabilitytoken = 92, RULE_acceptable = 93, 
		RULE_preferred = 94, RULE_conceptfilterconstraint = 95, RULE_conceptfilter = 96, 
		RULE_definitionstatusfilter = 97, RULE_definitionstatusidfilter = 98, 
		RULE_definitionstatusidkeyword = 99, RULE_definitionstatustokenfilter = 100, 
		RULE_definitionstatuskeyword = 101, RULE_definitionstatustoken = 102, 
		RULE_definitionstatustokenset = 103, RULE_primitivetoken = 104, RULE_definedtoken = 105, 
		RULE_modulefilter = 106, RULE_moduleidkeyword = 107, RULE_effectivetimefilter = 108, 
		RULE_effectivetimekeyword = 109, RULE_timevalue = 110, RULE_timevalueset = 111, 
		RULE_year = 112, RULE_month = 113, RULE_day = 114, RULE_activefilter = 115, 
		RULE_activekeyword = 116, RULE_activevalue = 117, RULE_activetruevalue = 118, 
		RULE_activefalsevalue = 119, RULE_memberfilterconstraint = 120, RULE_memberfilter = 121, 
		RULE_memberfieldfilter = 122, RULE_historysupplement = 123, RULE_historykeyword = 124, 
		RULE_historyprofilesuffix = 125, RULE_historyminimumsuffix = 126, RULE_historymoderatesuffix = 127, 
		RULE_historymaximumsuffix = 128, RULE_historysubset = 129, RULE_numericvalue = 130, 
		RULE_stringvalue = 131, RULE_integervalue = 132, RULE_decimalvalue = 133, 
		RULE_booleanvalue = 134, RULE_true_1 = 135, RULE_false_1 = 136, RULE_nonnegativeintegervalue = 137, 
		RULE_sctid = 138, RULE_ws = 139, RULE_mws = 140, RULE_comment = 141, RULE_nonstarchar = 142, 
		RULE_starwithnonfslash = 143, RULE_nonfslash = 144, RULE_sp = 145, RULE_htab = 146, 
		RULE_cr = 147, RULE_lf = 148, RULE_qm = 149, RULE_bs = 150, RULE_star = 151, 
		RULE_digit = 152, RULE_zero = 153, RULE_digitnonzero = 154, RULE_nonwsnonpipe = 155, 
		RULE_anynonescapedchar = 156, RULE_codechar = 157, RULE_escapedchar = 158, 
		RULE_escapedwildchar = 159, RULE_nonwsnonescapedchar = 160, RULE_alpha = 161, 
		RULE_dash = 162;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"codechar", "escapedchar", "escapedwildchar", "nonwsnonescapedchar", 
			"alpha", "dash"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "ECL.antlr"; }
	...
	public static class CodecharContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ECLListener ) ((ECLListener)listener).enterCodechar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ECLListener ) ((ECLListener)listener).exitCodechar(this);
		}
	}
	...
	public final CodecharContext codechar() throws RecognitionException {
		...
		try {
			...
			setState(2295);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -133145198592L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 536870907L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
