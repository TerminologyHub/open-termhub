...
public class FHIRTerminologyCapabilitiesProviderR4 extends ServerCapabilityStatementProvider {
	...
	public FHIRTerminologyCapabilitiesProviderR4(final RestfulServer theRestfulServer,
			final ISearchParamRegistry theSearchParamRegistry, final IValidationSupport theValidationSupport) {
	 ...
	 */
	@Metadata
	public IBaseConformance getMetadataResource(final HttpServletRequest request, final RequestDetails requestDetails) {
