...
public class FHIRMetadataProviderR5 extends ServerCapabilityStatementProvider {
   ...
   */
  public FHIRMetadataProviderR5(final FhirContext theContext,
   ...
   */
  public FHIRMetadataProviderR5(final RestfulServer theRestfulServer,
    ...
    try {
      ...
      // Check if the request is for general CapabilityStatement
        ...
        if (serverRestComponent.isPresent()) {
          ...
          boolean hasBatch = rest.getInteraction().stream()
              .anyMatch(i -> i.getCode() == CapabilityStatement.SystemRestfulInteraction.BATCH);
          if (!hasBatch) {
