...
public class FHIRTerminologyCapabilitiesR5 extends TerminologyCapabilities
  ...
  public FHIRTerminologyCapabilitiesR5 withDefaults(final HttpServletRequest request,
    ...
    setPurpose(
        "The Open Termhub Terminology Capability Statement provides a summary of the Termhub API's"
            + " capabilities.");
  ...
  private void setExpansion() {
    ...
    parameters.put("property", "Pre-adopted from R5.");
    parameters.put("useSupplement", "Pre-adopted from R5.");
