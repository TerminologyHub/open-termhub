...
//	private static Logger logger = LoggerFactory.getLogger(ProjectTenantIdentificationStrategy.class);
//
//	/* see superclass */
//	@Override
//	public void extractTenant(final UrlPathTokenizer theUrlPathTokenizer, final RequestDetails theRequestDetails) {
...
//			// If it's "metadata" or starts with "$", use DEFAULT partition and don't
//			// consume this
//			// token:
...
//			}
//
//			// It isn't metadata or $, so assume that this first token is the partition name
//			// and
//			// consume it:
//			else {
...
//		if (tenantId == null) {
//			final HapiLocalizer localizer = theRequestDetails.getServer().getFhirContext().getLocalizer();
...
//	/* see superclass */
//	@Override
//	public String massageServerBaseUrl(final String fhirServerBase, final RequestDetails requestDetails) {
