...
public final class FhirUtilityR4 {
	...
	public static Terminology getTerminology(final EntityRepositoryService searchService, final IdType id,
		...
		if (id == null && codeSystem == null && systemSystem == null && codingSystem == null) {
			...
			throw FhirUtilityR4.exception("Code system not found", IssueType.NOTFOUND, 404);
		}
		...
		if (list.size() > 1) {
			throw FhirUtilityR4.exception("Too many code systems found matching '" + systemField + "' "
		...
		if (system != null) {
			throw FhirUtilityR4.exception("Code system not found matching '" + systemField + "' parameter",
	 ...
	 * @throws Exception the exception
	 */
	public static Parameters toR4(final CodeSystem codeSystem, final Concept concept, final Set<String> properties,
	 ...
	 * @throws Exception the exception
	 */
	public static Parameters toR4ValidateCode(final CodeSystem codeSystem, final Concept concept, final String display)
			throws Exception {
	 ...
	 * @throws Exception the exception
	 */
	public static Parameters toR4Subsumes(final String outcome, final Terminology terminology) throws Exception {
	...
	public static CodeSystem toR4(final Terminology terminology) throws Exception {
		...
		cs.setHierarchyMeaning(org.hl7.fhir.r4.model.CodeSystem.CodeSystemHierarchyMeaning.ISA);
		...
		if (terminology.getPublisher().equals("SANDBOX")) {
			cs.setContent(org.hl7.fhir.r4.model.CodeSystem.CodeSystemContentMode.FRAGMENT);
		} else {
	...
	public static ConceptMap toR4(final Mapset mapset) throws Exception {
		final org.hl7.fhir.r4.model.ConceptMap cm = new org.hl7.fhir.r4.model.ConceptMap();
