...
public final class FhirUtility {
	 ...
	 * @throws Exception the exception
	 */
	public static List<Terminology> lookupTerminologies(final EntityRepositoryService searchService) throws Exception {
	...
	public static Terminology getTerminology(final EntityRepositoryService searchService, final String terminology,
		...
		final ResultList<Terminology> tlist = searchService.find(new SearchParameters(
				"abbreviation:" + terminology + " AND publisher:" + publisher + " AND version:" + version, 2, 0),
				Terminology.class);
	 ...
	 * @throws Exception the exception
	 */
	public static String getCodeSystemUri(final EntityRepositoryService searchService, final String terminology,
			final String publisher, final String version) throws Exception {
	 ...
	 * @throws Exception the exception
	 */
	public static String getCodeSystemUri(final EntityRepositoryService searchService, final ConceptRef concept)
			throws Exception {
		final Terminology t = getTerminology(searchService, concept.getTerminology(), concept.getPublisher(),
				concept.getVersion());
		return t == null ? null : t.getAttributes().get("fhirUri");
	}
	...
	public static Map<String, String> getDisplayMap(final EntityRepositoryService searchService,
		...
		final String key = terminology.getAbbreviation() + terminology.getPublisher() + terminology.getVersion();
	 ...
	 */
	public static String getNormalForm(final Concept concept, final List<ConceptRelationship> relationships,
			final Map<String, String> displayMap, final boolean terse) throws IOException {
		...
		for (final String parentCode : relationships.stream()
				.filter(r -> r.getHierarchical() != null && r.getHierarchical()).map(r -> r.getTo().getCode())
