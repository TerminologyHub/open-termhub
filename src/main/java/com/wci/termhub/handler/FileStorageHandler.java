...
public interface FileStorageHandler extends Configurable {
	 ...
	 * @throws Exception the exception
	 */
	public FileInfo putAndEncryptFile(String uri, InputStream is, String key, String salt) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public static FileStorageHandler findHandler(final List<FileStorageHandler> handlers, final String uri)
			throws Exception {
