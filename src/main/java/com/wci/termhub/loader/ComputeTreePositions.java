...
// LoggerFactory.getLogger(ComputeTreePositions.class);
//
...
//
// if (args.length != 3) {
// throw new Exception("Usage: ... markLatest <terminology> <publisher>
// <version>");
// }
//
...
// * @throws Exception the exception
// */
// public static void computeTreePositions(final String terminology, final
// String publisher, final String version)
// throws Exception {
//
