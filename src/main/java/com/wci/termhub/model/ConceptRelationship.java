...
public class ConceptRelationship extends AbstractHasModified
		implements TerminologyComponent, HasAttributes, Copyable<ConceptRelationship>, Comparable<ConceptRelationship> {
	...
	/**
	 * The defining flag. Indicates whether this relationship is part of the logical
	 * definition.
	 */
	@Field(type = FieldType.Boolean)
	 ...
	 * @return the group
	 */
	@Schema(description = "Represents a value used to group relationships whose " + "semantics are bound together.")
	 ...
	 * @return <code>true</code> if so, <code>false</code> otherwise
	 */
	@Schema(description = "Indicates whether or not this relationship is in the direction asserted by the terminology.")
