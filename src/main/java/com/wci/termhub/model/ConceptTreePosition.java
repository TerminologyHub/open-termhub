...
public class ConceptTreePosition extends AbstractTerminologyComponent implements Copyable<ConceptTreePosition> {
	...
	@Schema(description = "Type of relationship in a more specific sense, "
			...
			+ "will be used for the hierarchical relationship type asserted in the" + "published source data")
	 ...
	 */
	@Schema(description = "Dot-separated chain of codes from the " + "root of the tree to the parent code of this node")
	 ...
	 */
	private void getLeafNodesHelper(final ConceptTreePosition tree, final Set<ConceptTreePosition> leafNodes) {
