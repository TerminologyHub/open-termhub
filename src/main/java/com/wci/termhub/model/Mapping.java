 ...
 * terminology.
 */
@Schema(description = "Represents a mapping between a code in one terminology and code in another terminology")
...
public class Mapping extends AbstractTerminologyComponent
	 ...
	 * @return the to
	 */
	@Schema(description = "Reference to concept this map is \"to\" " + "(the destination or target concept)")
