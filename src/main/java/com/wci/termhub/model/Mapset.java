...
public class Mapset extends MapsetRef implements TerminologyComponent, HasAttributes {
   ...
   */
  public Mapset(final String abbreviation, final String terminology, final String publisher,
      final String version, final String releaseDate, final Boolean latest) {
  ...
  public int compareTo(final TerminologyRef other) {
    ...
    final String k1 = getAbbreviation() + (getAbbreviation().contains("RXNORM")
        && getVersion() != null && !getVersion().startsWith("20")
            ? getVersion().replaceFirst("(....)(....)", "$2$1") : getVersion());
    final String k2 = other.getAbbreviation() + (other.getAbbreviation().contains("RXNORM-")
        && getVersion() != null && !getVersion().startsWith("20")
            ? other.getVersion().replaceFirst("(....)(....)", "$2$1") : other.getVersion());
