...
public class MapsetRef extends TerminologyRef {
	 ...
	 */
	@Schema(description = "Terminology abbreviation that maps in this set are mapped to, " + "e.g. \"SNOMEDCT\"")
	 ...
	 */
	@Schema(description = "Terminology version that maps in this set are mapped to, " + "e.g. \"20230901\"")
	 ...
	 */
	@Schema(description = "Terminology abbreviation that maps in this set are mapped from, " + "e.g. \"SNOMEDCT\"")
	 ...
	 */
	@Schema(description = "Terminology version that maps in this set are mapped from, " + "e.g. \"20230901\"")
