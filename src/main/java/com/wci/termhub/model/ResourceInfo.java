...
@Schema(
    description = "Represents information about a resource like a video, web page, or other information")
...
public class ResourceInfo extends AbstractHasModified implements Copyable<ResourceInfo> {
  ...
  // final ResourceInfo resource = ModelUtility.fromJson(getData(),
  // this.getClass());
  // if (resource != null) {
