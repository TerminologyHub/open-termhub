...
public class TerminologyInfo extends AbstractHasModified implements HasLazyInit, Copyable<TerminologyInfo> {
	 ...
	 * looking at SNOMED. The set of labels can be managed by an enum if we want but
	 * is like this:
	 * 
	 * <pre>
...
//		final TerminologyInfo ti = ModelUtility.fromJson(getData(), this.getClass());
//		populateFrom(ti);
//	}
