...
public final class ExceptionHandler {
   ...
   * @param whatIsHappening the what is happening
   */
  // public static void emailException(final Throwable e, final String
  // whatIsHappening) {
  //
  // // Send email
  // try {
  ...
  // final String apiUrl =
  // PropertyUtility.getProperties().getProperty("api.url");
  // final String mailFrom =
  // PropertyUtility.getProperties().getProperty("mail.smtp.from");
  // final String mailRecipients =
  // PropertyUtility.getProperties().getProperty("mail.error.to");
  // final Map<String, String> config = new HashMap<>();
  // config.put("errorMessage", e.getMessage() == null ? "NULL MESSAGE" :
  // e.getMessage());
  // config.put("context",
  // ModelUtility.prettyFormatJson(ThreadContext.getContext()));
  // // Clear the context "detail"
  // ThreadContext.remove("detail");
  // String exception = null;
  // try (final StringWriter sw = new StringWriter(); final PrintWriter pw = new
  // PrintWriter(sw);) {
  ...
  // }
  // errorMap.put(whatIsHappening + exception, errorMap.get(whatIsHappening +
  // exception) + 1);
  ...
  // final String body =
  // sub.replace(FileUtility.resolveUri("classpath:data/messages/ERROR_REPORT.txt"));
  // EmailUtility.sendEmail("ERROR (" + ct + ") " + whatIsHappening + " = " +
  // apiUrl, mailFrom,
