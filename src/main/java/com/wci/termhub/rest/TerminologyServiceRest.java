...
public interface TerminologyServiceRest extends RootServiceRest {
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<Terminology> updateTerminology(String id, String terminologyStr) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListTerminology> findTerminologies(String query, Integer offset, Integer limit,
	 ...
	 * that the project has only a single terminology/publisher/version configured,
	 * otherwise it will return a 409. GET /concept/{terminology}/{code} tag=concept
	 * by code
	 *
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<Concept> getConcept(String terminology, String code, String include) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<List<Concept>> getConceptCodes(String terminology, String codes, String include)
			throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConcept> findConcepts(String terminology, String query, String expression,
			Integer offset, Integer limit, String sort, Boolean ascending, Boolean active, Boolean leaf, String include,
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListTerm> findTerms(String terminology, String query, Integer offset, Integer limit,
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListMetadata> findMetadata(String query, Integer offset, Integer limit, String sort,
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptRelationship> findConceptRelationships(String conceptId, String query,
			Integer offset, Integer limit, Boolean ascending, String sort, String handler) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptRelationship> findConceptRelationships(String terminology, String code,
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptRelationship> findConceptInverseRelationships(String conceptId, String query,
			Integer offset, Integer limit, Boolean ascending, String sort, String handler) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptRelationship> findConceptInverseRelationships(String terminology,
			String code, String query, Integer offset, Integer limit, Boolean ascending, String sort, String handler)
			throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptTreePosition> findTreePositions(String conceptId, String query,
			Integer offset, Integer limit, Boolean ascending, String sort, String handler) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptTreePosition> findTreePositions(String terminology, String code,
			String query, Integer offset, Integer limit, Boolean ascending, String sort, String handler)
			throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResponseEntity<ResultListConceptTreePosition> findTreePositionChildren(String conceptId, String query,
			Integer offset, Integer limit, Boolean ascending, String sort, String handler) throws Exception;
