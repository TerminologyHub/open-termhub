...
public interface ConfigClient extends RootClient {
	 ...
	 * @throws Exception the exception
	 */
	public TerminologyInfo updateTerminologyInfo(String id, TerminologyInfo terminology) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public ResultListTypeKeyValue findTypeKeyValue(String query, Integer offset, Integer limit, String sort,
