...
public interface EntityRepositoryService {
	 ...
	 * @throws Exception the exception
	 */
	public <T extends HasId> ResultList<T> find(final SearchParameters params, final Class<T> clazz) throws Exception;
	 ...
	 * @throws Exception the exception
	 */
	public <T extends HasId> List<T> findAllWithFields(String query, List<String> fields, Class<T> clazz,
			FindCallbackHandler<T> handler) throws Exception;
