...
public final class DateUtility {
	...
	public static final FastDateFormat UTC_YYYYMMDD = FastDateFormat.getInstance("yyyyMMdd",
	...
	public static final FastDateFormat UTC_MMDDYYYY = FastDateFormat.getInstance("MMddyyyy",
			TimeZone.getTimeZone("UTC"));
	...
	public static Date getEndOfDay(final String yyyymmdd, final String timeZone) {
		return Date.from(LocalDate.parse(yyyymmdd, DAY).atTime(LocalTime.MAX).atZone(ZoneId.of(timeZone)).toInstant());
	}
	 ...
	 */
	public static Date getDate(final String dateStr, final String pattern, final String timeZone) throws Exception {
