...
public final class HandlerUtility {
	 ...
	 */
	public static <T extends Configurable> T newStandardHandlerInstanceWithConfiguration(final String property,
			final String handlerName, final Class<T> type) throws Exception {
