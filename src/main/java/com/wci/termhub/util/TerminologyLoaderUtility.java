...
/// LoggerFactory.getLogger(TerminologyLoaderUtility.class);
//
// /**
// * Load terminology.
// *
...
// * @throws Exception the exception
// */
// public static void loadMetadata(final EntityRepositoryService service, final
/// String terminology)
// throws Exception {
...
// * @throws Exception the exception
// */
// public static void loadConcepts(final EntityRepositoryService service, final
/// String terminology)
// throws Exception {
...
// * @throws Exception the exception
// */
// public static void loadConceptRelationships(final EntityRepositoryService
/// service,
// final String terminology, final boolean computeTreePositions) throws
/// Exception {
...
// * @throws Exception the exception
// */
// public static void loadMapset(final EntityRepositoryService service, final
/// String terminology)
// throws Exception {
...
// final String fullFileName, final int batchSize, final int limit) throws
/// Exception {
//
// LOGGER.debug("indexTerminology: batch size: " + batchSize + " limit: " +
/// limit);
// final long startTime = System.currentTimeMillis();
// final List<HasId> terminologyBatch = new ArrayList<>(batchSize);
//
// try (final BufferedReader br = new BufferedReader(new
/// FileReader(fullFileName))) {
//
...
//
// final Terminology terminology = ModelUtility.fromJson(line,
/// Terminology.class);
...
// LOGGER
// .info("indexTerminology: duration: " + (System.currentTimeMillis() -
/// startTime) + " ms");
//
...
// * @throws Exception the exception
// */
// public static void indexMetadata(final EntityRepositoryService service, final
/// String fullFileName,
...
// String line;
// int conceptCount = 0;
// while ((line = br.readLine()) != null && (limit == -1 || conceptCount <
/// limit)) {
//
...
// }
//
// LOGGER.info("indexMetadata: final metadataBatch added count: " +
/// conceptCount);
// LOGGER.info("indexMetadata: duration: " + (System.currentTimeMillis() -
/// startTime) + " ms");
//
// } catch (final Exception e) {
...
// * @throws Exception the exception
// */
// public static void indexConcepts(final EntityRepositoryService service, final
/// String fullFileName,
// final int batchSize, final int limit) throws Exception {
//
...
// LOGGER.info("indexConcept: duration: " + (System.currentTimeMillis() -
/// startTime) + " ms");
//
// } catch (final Exception e) {
...
// * @throws Exception the exception
// */
// public static void indexConceptRelationships(final EntityRepositoryService
/// service,
// final String fullFileName, final int batchSize, final int limit,
// final boolean computeTreePositions) throws Exception {
//
// LOGGER.debug("indexConceptRelationships: batch size: {} limit: {}",
/// batchSize, limit);
// final long startTime = System.currentTimeMillis();
...
// * @throws Exception the exception
// */
// public static void indexMapset(final EntityRepositoryService service, final
/// String fullFileName,
// final int batchSize, final int limit) throws Exception {
//
...
// String line;
// int mappingCount = 0;
// while ((line = br.readLine()) != null && (limit == -1 || mappingCount <
/// limit)) {
//
...
// LOGGER.info("indexMappings: duration: {} ms", System.currentTimeMillis() -
/// startTime);
//
// } catch (final Exception e) {
...
// * @throws Exception the exception
// */
// private static void computeConceptTreePositions(final EntityRepositoryService
/// service,
