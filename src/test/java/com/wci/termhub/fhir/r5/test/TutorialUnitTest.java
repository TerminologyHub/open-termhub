...
class TutorialUnitTest extends AbstractFhirR5ServerTest {
  ...
  public static void beforeAll() {
    tutorialResources =
        TestUtils.getUrlsFromMarkdown("doc/TUTORIAL1.md", "Testing the FHIR R5 API");
  }
  ...
  // Test for: curl -s
  // 'http://localhost:8080/fhir/r5/CodeSystem/$lookup?system=http://snomed.info/sct&code=73211009'
  // | jq
  @Test
  @Order(2)
   ...
   */
  // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet?url=http://snomed.info/sct?fhir_vs' |
  // jq
  @Test
  @Order(6)
   ...
   */
  // Test for: curl -s
  // 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs' | jq
  @Test
  @Order(9)
   ...
   */
  // Test for: curl -s
  // 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs&filter=diabetes'
  // | jq
  @Test
  @Order(11)
