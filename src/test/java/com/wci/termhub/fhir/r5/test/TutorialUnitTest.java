...
class TutorialUnitTest extends AbstractFhirR5ServerTest {
    ...
    public static void beforeAll() {
        tutorialResources = TestUtils.getUrlsFromMarkdown("doc/TUTORIAL1.md", "Testing the FHIR R5 API");
    }

    // Test for: curl -s 'http://localhost:8080/fhir/r5/CodeSystem' | jq
    @Test
    @Order(1)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/CodeSystem/$lookup?system=http://snomed.info/sct&code=73211009' | jq
    @Test
    @Order(2)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ConceptMap' | jq
    @Test
    @Order(3)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ConceptMap/$translate?url=http://snomed.info/sct?fhir_cm=6011000124106&sourceSystem=http://snomed.info/sct&sourceCode=300862005' | jq
    @Test
    @Order(4)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet' | jq
    @Test
    @Order(5)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet?url=http://snomed.info/sct?fhir_vs' | jq
    @Test
    @Order(6)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet?url=http://snomed.info/sct?fhir_vs=731000124108' | jq
    @Test
    @Order(7)
    ...
    // Test for: curl -s "http://localhost:8080/fhir/r5/ValueSet/$id" | jq
    @Test
    @Order(8)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs' | jq
    @Test
    @Order(9)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs=731000124108' | jq
    @Test
    @Order(10)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs&filter=diabetes' | jq
    @Test
    @Order(11)
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs=731000124108&filter=diabetes' | jq
    @Test
    @Order(12)
    void testExpandExplicitValueSetWithFilter() {
        String url = "/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs=731000124108&filter=diabetes";
        ResponseEntity<String> response =
                restTemplate.getForEntity(url, String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        String body = response.getBody();
    ...
    // Test for: curl -s 'http://localhost:8080/fhir/r5/ValueSet/$expand?url=http://snomed.info/sct?fhir_vs=ecl/%3C%3C128927009&filter=gastrointestinal' | jq
    @Test
    @Order(13)
