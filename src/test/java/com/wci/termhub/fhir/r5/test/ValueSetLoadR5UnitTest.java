 ...
 */
public class ValueSetLoadR5UnitTest extends AbstractFhirR5ServerTest {
  /** The logger. */
  private static final Logger LOGGER = LoggerFactory.getLogger(ValueSetLoadR5UnitTest.class);
    ...
    for (final String valueSetFile : VALUE_SET_FILES) {
      try {
        ...
        final Resource resource = new ClassPathResource("data/" + valueSetFile,
            ValueSetLoadR5UnitTest.class.getClassLoader());
