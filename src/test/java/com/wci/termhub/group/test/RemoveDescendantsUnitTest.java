...
public class RemoveDescendantsUnitTest extends AbstractTerminologyTest {
  ...
  public void testRemoveDescendants() throws Exception {
    ...
    Terminology term =
        TerminologyUtility.getTerminology(searchService, "SNOMEDCT_US", "SANDBOX", "20240301");
    if (term == null) {
    ...
    SearchParameters params =
        new SearchParameters("leaf:false AND terminology:SNOMEDCT_US", 100, 0);
    ...
    ResponseEntity<List<String>> response =
        restService.computeRemoveDescendants("SNOMEDCT_US", codesParam);
    ...
    // Without aggregate
    ResponseEntity<ResultListConcept> findResp = restService.findTerminologyConcepts("SNOMEDCT_US",
        query, null, null, null, null, null, null, null, null, null, null);
    assertEquals(2, findResp.getBody().getItems().size());

    // With aggregate
    findResp = restService.findTerminologyConcepts("SNOMEDCT_US", query, null, null, null, null,
        null, null, null, null, "removeDescendants", null);
