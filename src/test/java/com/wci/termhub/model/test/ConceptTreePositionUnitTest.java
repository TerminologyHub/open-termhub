...
/**
 * Unit testing for model object ConceptTreePosition.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest
public class ConceptTreePositionUnitTest extends AbstractTest {

	/** The model object to test. */
	private ConceptTreePosition object;
	...
	public void setup() throws Exception {
		object = new ConceptTreePosition();
	...
	public void testModelCopy() throws Exception {
		...
		tester.proxy(ConceptRef.class, 1, c1);
		assertTrue(tester.testCopyConstructor(ConceptTreePosition.class));
	}
