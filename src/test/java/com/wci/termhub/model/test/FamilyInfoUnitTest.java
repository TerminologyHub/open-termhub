...
@SpringBootTest
public class FamilyInfoUnitTest extends AbstractTest {

  /** The logger. */
  @SuppressWarnings("unused")
  private final Logger logger = LoggerFactory.getLogger(FamilyInfoUnitTest.class);

  /** The model object to test. */
  private FamilyInfo object;
  ...
  public void testModelCopy() throws Exception {
    ...
    assertTrue(tester.testCopyConstructor(FamilyInfo.class));
  }
