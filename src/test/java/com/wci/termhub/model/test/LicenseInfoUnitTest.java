...
/**
 * Unit testing for model object {@link LicenseInfo}.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest
public class LicenseInfoUnitTest extends AbstractTest {

  /** The logger. */
  @SuppressWarnings("unused")
  private final Logger logger = LoggerFactory.getLogger(LicenseInfoUnitTest.class);
  ...
  public void testModelCopy() throws Exception {
    ...
    assertTrue(tester.testCopyConstructor(LicenseInfo.class));
  }
