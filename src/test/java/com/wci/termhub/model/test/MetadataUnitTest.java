...
/**
 * Unit testing for model object Metadata.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest
public class MetadataUnitTest extends AbstractTest {

  /** The logger. */
  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger(MetadataUnitTest.class);
  ...
  public void testModelCopy() throws Exception {
    ...
    assertTrue(tester.testCopyConstructor(Metadata.class));
  }
