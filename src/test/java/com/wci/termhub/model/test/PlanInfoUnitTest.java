...
/**
 * Unit test for {@link PlanInfo}.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest
public class PlanInfoUnitTest extends AbstractTest {

  /** The logger. */
  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger(PlanInfoUnitTest.class);
  ...
  public void testModelCopy() throws Exception {
    ...
    assertTrue(tester.testCopyConstructor(PlanInfo.class));
  }
