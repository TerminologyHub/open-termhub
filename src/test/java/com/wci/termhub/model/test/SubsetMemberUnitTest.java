...
/**
 * Unit testing for model object SubsetMember.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest
public class SubsetMemberUnitTest extends AbstractTest {

  /** The logger. */
  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger(SubsetMemberUnitTest.class);

  /** The model object to test. */
  private SubsetMember object;
  ...
  /** The c 1. */
  private SubsetRef c1;

  /** The c 2. */
  private SubsetRef c2;
  ...
  public void setup() throws Exception {
    object = new SubsetMember();

    final ProxyTester tester = new ProxyTester(new SubsetRef());
    c1 = (SubsetRef) tester.createObject(1);
    c2 = (SubsetRef) tester.createObject(2);
  ...
  public void testModelGetSet() throws Exception {
    ...
    tester.proxy(SubsetRef.class, 1, c1);
    tester.proxy(SubsetRef.class, 2, c2);
  ...
  public void testModelCopy() throws Exception {
    ...
    tester.proxy(SubsetRef.class, 1, c1);
    tester.proxy("attributes", 1, at1);
    assertTrue(tester.testCopyConstructor(SubsetMember.class));
  }
