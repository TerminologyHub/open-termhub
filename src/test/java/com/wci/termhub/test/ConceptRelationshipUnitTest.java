...
public class ConceptRelationshipUnitTest extends BaseUnitTest {
    ...
    public void testAddConceptRelationship() throws Exception {
        ...
        if (conceptRelNode != null) {
            conceptRelationship =
                    objectMapper.treeToValue(conceptRelNode, ConceptRelationship.class);
            logger.info("Concept Relationship: {}", conceptRelationship);
            assertDoesNotThrow(
                    () -> searchService.add(ConceptRelationship.class, conceptRelationship));
        } else {
    ...
    public void findConceptRelationshipById() throws Exception {
        ...
        final ConceptRelationship foundConceptRelObjects = searchService
                .get("84234204-cfc9-4258-a07b-9c13cf02b70b", ConceptRelationship.class);
