...
public class GetterSetterTester extends ProxyTester {
	 ...
	 * @throws Exception the exception
	 */
	private void testGetterSetter(final String field, final Method get, final Method set, final Class<?> argType)
			throws Exception {
		if (this.verbose) {
		...
		try {
			...
			throw new RuntimeException("Getter " + get.getDeclaringClass().getName() + "." + set.getName() + " threw "
					+ e.getTargetException().toString());
		}
		...
		throw new RuntimeException(
				"Getter " + get.getName() + " did not return value from setter: " + proxy + ", " + getResult);
	}
